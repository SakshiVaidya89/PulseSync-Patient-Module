  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 pb-4 border-b border-slate-200 gap-2.5">
        <h3 className="text-lg font-bold text-sky-900 m-0">{appointment.doctorName}</h3>
      ...
      <div className="flex flex-col gap-2.5 mb-4">
        <p className="m-0 text-sm text-slate-600">
          <strong className="text-sky-900">Specialty:</strong> {appointment.specialty}
        </p>
        <p className="m-0 text-sm text-slate-600">
          <strong className="text-sky-900">Hospital:</strong> {appointment.hospital}
        </p>
        <p className="m-0 text-sm text-slate-600">
          <strong className="text-sky-900">Date & Time:</strong> {appointment.date} at {appointment.time}
        </p>
        <p className="m-0 text-sm text-slate-600">
          <strong className="text-sky-900">Reason:</strong> {appointment.reason}
        </p>
        <p className="m-0 text-sm text-slate-600 bg-sky-50 p-2.5 rounded-md border-l-[3px] border-l-sky-500">
          <strong className="text-sky-900">Notes:</strong> {appointment.notes}
        </p>
      </div>
